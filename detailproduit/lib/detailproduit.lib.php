...
/**
 * \file    detailproduit/lib/detailproduit.lib.php
 * \ingroup detailproduit
 * \brief   Library files with common functions for Detailproduit
 */
...
function detailproduitAdminPrepareHead()
{
	...
	/*
	$head[$h][0] = dol_buildpath("/detailproduit/admin/myobject_extrafields.php", 1);
	...
	*/
	...
	//$this->tabs = array(
	//	'entity:+tabname:Title:@detailproduit:/detailproduit/mypage.php?id=__ID__'
	//); // to add new tab
	//$this->tabs = array(
	//	'entity:-tabname:Title:@detailproduit:/detailproduit/mypage.php?id=__ID__'
	//); // to remove a tab
